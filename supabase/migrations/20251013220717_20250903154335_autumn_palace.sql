...
-- 1. Storage Bucket: Crear bucket 'remision-images' para almacenar las imágenes
-- 2. Políticas de Storage: Permitir lectura pública, subida y eliminación para usuarios autenticados
-- 3. Configuración: Tamaño máximo de archivo: 5MB, Tipos de archivo permitidos: image/*
