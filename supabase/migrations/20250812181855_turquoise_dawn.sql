...
-- Crear bucket de storage (esto se debe hacer desde el dashboard de Supabase)
-- INSERT INTO storage.buckets (id, name, public) VALUES ('remision-images', 'remision-images', true);

-- Políticas de storage para el bucket (se configuran desde el dashboard)
-- Lectura pública: permitir a todos leer las imágenes
-- Subida: solo usuarios autenticados pueden subir imágenes